CREATE DEFINER=`root`@`localhost` PROCEDURE `MJERENJE_REZULTAT`( IN adresaId INT , IN vrijeme TIMESTAMP,
...
BEGIN
	...
	select id_mjerenje from mjerenje where adresa_id=adresaId and vrijeme_mjerenja=vrijeme
    into @mjerenjeId;
